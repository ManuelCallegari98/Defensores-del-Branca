            ...
            <header className="font-custom text-white body-font bg-[#870A28] w-full z-10">
                <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
                    ...
                    <a className="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
                        <Link to="/home" className="flex items-center text-white text-xl"><img src="/LogoDDB.png" cursor="pointer" alt="Logo" width={50} height={70} layout="fill" className="transition-all duration-300 transform hover:scale-110 mr-2" />{' '}Defensores del Branca</Link>
                        
                    </a>
                    <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
                        <Badge className="w-1 h-auto" content={1} shape="circle">
