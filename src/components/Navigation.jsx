        ...
        <header className="text-white body-font bg-[#870A28] ">
            <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
                ...
                <a className="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
                    <Link to="/home"><img src="/LogoDDB.png" cursor="pointer" alt="Logo" width={50} height={70} layout="fill" className="transition-all duration-300 transform hover:scale-110" /></Link>
