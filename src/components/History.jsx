...
const History = () => {
    return (
        <div className="flex flex-col items-center font-custom p-4 flex-grow">
            <img src="/LogoDDB.png" alt="Descripción de la imagen" className="fixed top-[45%] left-[50%] transform -translate-x-[50%] -translate-y-[50%] z-[-1] w-auto md:h-full h-[40vh] opacity-30" />
