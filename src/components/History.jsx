...
const History = () => {
    return (
        <div className="flex flex-col items-center font-custom p-4 flex-grow">
            <img src="/LogoDDB.png" alt="Descripción de la imagen" className="fixed top-[45%] left-[50%] transform -translate-x-[50%] -translate-y-[50%] z-[-1] w-auto md:h-full h-[40vh] opacity-10" />
            ...
            <div className="p-1 gap-2 flex flex-col md:flex-row items-center justify-center pt-12 ">
                ...
                <img src="https://i.ibb.co/WVngRxL/1er-A-o-DDB.jpg" alt="Imagen 1" className="h-full w-full md:h-[60vh] md:w-auto lg:h-[60vh] md:order-last " />
            </div>
            <div className="p-1 gap-2 flex flex-col md:flex-row items-center justify-center pt-12">
